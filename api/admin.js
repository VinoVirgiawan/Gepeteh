...
function parseCookies(h) {
  ...
  h.split(';').forEach(s => { const [k, ...v] = s.trim().split('='); c[k] = decodeURIComponent(v.join('=')); }); return c;
}
...
function dashPage() {
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>CheatGPT Admin</title>'
  + '<style>'
  + '*{margin:0;padding:0;box-sizing:border-box}:root{--bg:#0a0a0f;--card:#12121a;--border:#1e1e2e;--accent:#6c5ce7;--a2:#a29bfe;--green:#00b894;--red:#ff6b6b;--text:#e0e0e0;--t2:#888}'
  ...
  + '.sc .i{font-size:28px;margin-bottom:8px}.sc .v{font-size:28px;font-weight:700;margin-bottom:4px}.sc .l{font-size:13px;color:var(--t2)}'
  ...
  + '.kh{display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:10px}.kh h2{font-size:18px;font-weight:600}'
  ...
  + '.mo{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,.7);backdrop-filter:blur(4px);display:none;align-items:center;justify-content:center;z-index:1000;padding:20px}.mo.on{display:flex}'
  ...
  + '.fg input{width:100%;padding:10px 14px;background:rgba(255,255,255,.05);border:1px solid var(--border);border-radius:8px;color:var(--text);font-size:13px;outline:none}.fg input:focus{border-color:var(--accent)}'
  + '.dl{list-style:none;padding:0}.di{display:flex;align-items:center;gap:12px;padding:10px 14px;background:rgba(255,255,255,.03);border-radius:10px;margin-bottom:8px;font-size:13px}'
  ...
  + '.rct .rh{text-align:center;margin-bottom:24px;padding-bottom:16px;border-bottom:2px dashed rgba(108,92,231,.3)}.rct .rh h3{font-size:20px;color:var(--a2);margin-bottom:4px}.rct .rh p{color:var(--t2);font-size:12px}'
  ...
  + '<div class="hdr"><h1>&#x26A1; CheatGPT Dashboard</h1><div class="ha">'
  ...
  + '<div class="st"><div class="sc"><div class="i">&#x1F511;</div><div class="v" id="tK">0</div><div class="l">Total Keys</div></div>'
  ...
  + '<div class="sc"><div class="i">&#x1F4CA;</div><div class="v" id="tU">0</div><div class="l">Uses</div></div></div>'
  + '<div class="tb"><button class="tbb on" id="tabK" onclick="sw(\'keys\')">&#x1F4CB; Keys</button>'
  + '<button class="tbb" id="tabH" onclick="sw(\'history\')">&#x1F4DA; History</button></div>'
  ...
  + '<tbody id="kB"></tbody></table><div class="es" id="eS" style="display:none"><p>&#x1F4ED; No keys yet</p></div></div>'
  + '<div id="tabHistory" class="ks" style="display:none"><div class="kh"><h2>&#x1F4DA; History</h2></div>'
  + '<div id="hL"></div><div class="es" id="eH" style="display:none"><p>&#x1F4DA; No history</p></div></div>'
  ...
  + '<div class="rct" id="rCt"></div><div class="ma"><button class="bs" onclick="closeM(\'rM\')">Close</button>'
  ...
  + '<ul class="dl" id="dL"></ul><div class="ma"><button class="bs" onclick="closeM(\'dM\')">Close</button></div></div></div>'
...
module.exports = async (req, res) => {
  ...
  if (logged && !act) {
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
    return res.status(200).send(dashPage());
  }
  res.setHeader('Content-Type', 'text/html; charset=utf-8');
